...
access_key = 'AKIAJ63KQVYTZ2UUUJHA'
secret = 'bbaLn1qexb/mr6LYIuXSifqABR/rEs+jyK4sTQq5'
...
defs = {'picket': 'a soldier or a sentry',
...
diffs = sample(list(range(5)+range(5)))
ndefarr = sample(defarr)
degrees = range(1,5)+range(1,5)

for x in ndefarr:
	x[1] = sample(d1.defs[x[0]])[0].lower()
